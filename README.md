...
[![GitHub Code Style Action Status](https://github.com/spatie/package-utils-laravel/actions/workflows/fix-php-code-style-issues.yml/badge.svg)](https://github.com/alexmanase/utils/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/utils.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/utils)
...
```bash
php artisan vendor:publish --tag="utils-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="utils-views"
```
